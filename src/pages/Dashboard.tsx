          ...
          <div key={stat.label}>
            <Card className="p-0 border-none bg-slate-800/20">
              <div className="p-6 flex flex-col gap-4">
                <div
                  className={cn('w-12 h-12 rounded-2xl flex items-center justify-center', stat.bg)}
                >
          ...
          <div className="space-y-4">
            {criticalProducts.length > 0 ? (
              criticalProducts.map((product) => (
                <div
                  key={product.id}
                  className="flex justify-between items-center p-4 bg-red-500/5 border border-red-500/10 rounded-2xl"
                >
                  <div>
              ...
              <div key={i} className="flex items-center gap-4">
                <div
                  className={cn(
                    ...
                    i % 2 === 0 ? 'bg-orange-500/10' : 'bg-blue-500/10',
                  )}
                >
                  {i % 2 === 0 ? (
                ...
                <p
                  className={cn(
                    'font-mono font-bold',
                    i % 2 === 0 ? 'text-orange-400' : 'text-blue-400',
                  )}
                >
                  {i % 2 === 0 ? '-5L' : '+60L'}
                </p>
